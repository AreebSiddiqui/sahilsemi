...
{
    int result;
    sn0 = alloc_netdev(0, "sn0%d", sn0, virtual_setup);
    sn1 = alloc_netdev(0, "sn1%d", sn1, virtual_setup);
    ...
    if ((result = register_netdev(sn1))){
        printk("sn1: Error %d initalizing card ...", result);
        return result;
    }
    return 0;
}
